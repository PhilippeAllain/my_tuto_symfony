 ...
 */
final class Version20260603121929 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP api_token, CHANGE roles roles JSON NOT NULL COMMENT \'(DC2Type:json)\'');
    }
}
